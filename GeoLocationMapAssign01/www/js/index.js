...
Requirements: GeoLocation Map Assignment - Accessing the map locations using a Serch Button with Marker on the map location
Last Modified on: 10/31/2014

 */

var app = {
    // mapID: null  - Not required
    ...
    onDeviceReady: function() {
      ...
      // use it if you need your default location
...
//            app.onError
    ...
    searchLoc:function(){
        ...
        document.getElementById('searchLoc').disabled = false;
...
// Option 1a - Using the User Inputs - Govi Rajagopal

// var x=prompt("enter your value for Latitude:")
// var y=prompt("enter your value for Longitude:")
// var latLng = new google.maps.LatLng(x,y);

// // Option 1b - Hardcoding the Inputs - Govi Rajagopal
// var latLng = new google.maps.LatLng(37.359,121.924);


// Test code by Govi Rajagopal
//new google.maps.LatLng(
//    37.35917,121.92417
//   );
